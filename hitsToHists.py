...
# the geometry can be used to automatically derive the number of bins. this is not done for now
...
# the tracks can be used to determine the class / desired outcome(s) for each event	# they may not end up as "features" !
