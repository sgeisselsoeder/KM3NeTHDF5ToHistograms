...
echo yzt && rm -f yzt.ssv && for i in {1..100}; do echo $i && ls 4dTo3d/yzt/hist___hdf5files_km3_v4_*_${i}_JTE_r2356_root_h5_yzt.csv && cat 4dTo3d/yzt/hist___hdf5files_km3_v4_*_${i}_JTE_r2356_root_h5_yzt.csv >> yzt.ssv ; done ; sed 's/,*$//' yzt.ssv > yzt.csv ; rm yzt.ssv
